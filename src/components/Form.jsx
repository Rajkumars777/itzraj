...
const Form = () => {
    ...
    const formSubmitHandler = (e) => {
        ...
        send(
            "service_0jdxj3j", // Service ID
            "template_o2k9hzx", // Template ID
            userInput,
            "pcbNTvmHbhQHPQdsN" // Public Key - https://dashboard.emailjs.com/admin/account
        )
            .then((response) => {
    ...
    return (
        <Div className="max-w-[1200px] mx-auto">
            ...
            >
                ...
                {/* SUBMIT BUTTON */}
                {/* SUBMIT BUTTON */}
<button className="bg-[#111111] margin-auto h-[64px] justify-center width-[200px] item-[center] max-w-[585px] text-[16px] transition-transform active:scale-[0.95]">
    Send Now
</button>
{/* SUBMIT BUTTON */}
