...
import man from "/src/assets/raj1.png";
import externalLinkIcon from "/src/assets/revil.png";
import gmailIcon from "/src/assets/email-icon.png";
...
const HeroBanner = () => {
    ...
    return (
            ...
            <Wrapper>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-bold">Raj Kumar S,</span>
                    </div>
                ...
                {/* PERSON BLOCK START */}
                <motion.div
                    className="w-[300px] md:w-[360px] 2xl:w-[350px] absolute bottom-[-57px] left-[50%] -translate-x-1/2"
                    initial={{ y: 200, x: "-50%" }}
                    animate={{ y: 0 }}
                    transition={{ duration: 0.5 }}
                >
                    <img className="w-[7000px] md:w-[8000px] bottom-[-78px] 2xl:w-[8000px] absolute bottom-0" src={man} alt="" />
        ...
        <a href="https://www.linkedin.com/in/raja-kumar-s-a52334258/" style={iconStyle}>
          <i className="fab fa-linkedin"></i>
        </a>
        <a href="https://github.com/Rajakumarcsecs/" style={iconStyle}>
          <i className="fab fa-github"></i>
        </a>
        <a href="https://linktr.ee/WHO_AM_l" style={iconStyle}>
